...
CPP_SRCS += \
../Application/Data/propulsion/store.cpp 

OBJS += \
./Application/Data/propulsion/store.o 

CPP_DEPS += \
./Application/Data/propulsion/store.d 


# Each subdirectory must supply rules for building sources it contributes
Application/Data/propulsion/%.o Application/Data/propulsion/%.su Application/Data/propulsion/%.cyclo: ../Application/Data/propulsion/%.cpp Application/Data/propulsion/subdir.mk
...
clean: clean-Application-2f-Data-2f-propulsion

clean-Application-2f-Data-2f-propulsion:
	-$(RM) ./Application/Data/propulsion/store.cyclo ./Application/Data/propulsion/store.d ./Application/Data/propulsion/store.o ./Application/Data/propulsion/store.su

.PHONY: clean-Application-2f-Data-2f-propulsion
