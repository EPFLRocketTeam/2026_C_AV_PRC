...
#define ETH_SETUP_Pin GPIO_PIN_2
#define ETH_SETUP_GPIO_Port GPIOA
#define LOX_SETUP_Pin GPIO_PIN_3
...
#define LMT85_Pin GPIO_PIN_1
#define LMT85_GPIO_Port GPIOB
...
#define ENG_ON_Pin GPIO_PIN_5
#define ENG_ON_GPIO_Port GPIOD
